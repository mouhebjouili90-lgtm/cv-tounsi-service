  ...
  ${!isUnlocked ? `
    <div class="watermark-overlay">
      <div class="watermark-text">
        ...
        <a href="https://wa.me/21692067554?text=Bonjour%20!%20Je%20souhaite%20d%C3%A9bloquer%20mon%20CV%20en%20Haute%20D%C3%A9finition." target="_blank" style="display: inline-block; background: #25D366; color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 800; font-family: 'Inter', sans-serif; padding: 10px 22px; border-radius: 8px; margin-top: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.15);">
